...
6. **Database Initialization**: Execute `pdocker compose -f ./docker-compose-dev.yml up -d` to initialize the database. This will create the database and the tables needed for the API.
